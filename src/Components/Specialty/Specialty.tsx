...
function Specialty() {
    ...
    return (
        <section  data-aos="fade-up">
            ...
            <div className='border-2 border-gray-700 rounded-3xl grid grid-cols-3 p-8 m-8'>
                <div className='flex flex-col flex-wrap m-2'>
                    <div className='flex flex-row p-2'>
                        <FontAwesomeIcon icon={faCodePullRequest} />
                        <h3 className='pl-2 items-baseline'>軟體工程</h3>
                    </div>
                ...
                <div className='flex flex-col flex-wrap m-2'>
                    <div className='flex flex-row p-2'>
                        ...
                        <h3 className='pl-2 items-baseline'>物件導向</h3>
                    </div>
                ...
                <div className='flex flex-col flex-wrap'>
                    <div className='flex flex-row p-2'>
                        ...
                        <h3 className='pl-2 items-baseline'>程式教學</h3>
                    </div>
